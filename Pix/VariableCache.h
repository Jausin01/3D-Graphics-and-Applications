...
// forward declaration "Variable"
// this means we will define this later, just trust me bro, it exists!
struct Variable;
...
public:
	...
	void AddInt(const std::string& name, int value, float speed = 1.0f, int  min = -INT16_MIN, int max = INT_MAX);
